...
public class TestEjemploFicheros {
	...
	public void testLeerYEscribirAFicheroSerializado() {
		EjemploFicheros.escribirAFicheroSerializado( "test/res/test-usuarios-serializado.dat", miListaUsuarios );
		ArrayList<Usuario> l = EjemploFicheros.leerDeFicheroSerializado( "test/res/test-usuarios-serializado.dat" );
		assertEquals( miListaUsuarios.size(), l.size() );
		assertEquals( miListaUsuarios, l );  // Las listas deben ser iguales
		l.clear();
	}
