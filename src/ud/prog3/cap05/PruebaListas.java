...
public class PruebaListas {
	...
	//	Long lll = null;
	//	Integer iii = null;
		AnalisisEjecucionConSizeOf.visuMem( "Al inicio", true );
		AnalisisEjecucionConSizeOf.visuMem( "Tras inicialización", true );
	//	lll = new Long(5);
	...
	//	System.out.println( iii );
		if (numPrueba==1 || numPrueba==3) {
			...
			AnalisisEjecucionConSizeOf.visuMem( "Tras crear ArrayList (tam = " + l.size() + ", cap = " + UtilidadArrayList.getArrayListCapacity(l) + ")", true, true );
			int num = 75;
			for (int i=0; i<num; i++) {
				int numAdds = 1;
				for (int j=0; j<numAdds; j++) l.add(null);
				AnalisisEjecucionConSizeOf.visuMem( "Tras meter " + numAdds + " datos nulos en ArrayList (tam = " + l.size() + ", cap = " + UtilidadArrayList.getArrayListCapacity(l) + ")", false );
			}
		}
