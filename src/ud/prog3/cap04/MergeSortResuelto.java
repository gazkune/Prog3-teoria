...
public class MergeSortResuelto {
	...
	public static void mergeSort( int[] nums, int ini, int fin ) {
		...
		if (ini>=fin) {
			...
			int med = (ini+fin)/2;
			//System.out.println("Cálculo de med: " + med);
		...
		private static void mezclaMergeSort( int[] nums, int ini1, int fin1, int fin2 ) {
			// Prints iniciales para verificar el estado
			System.out.println("Mezcla (ini1: " + ini1 + ", fin1: " + fin1 + ", fin2:" + fin2 + ")");
			System.out.print("Vector izquierdo: ");
			for (int i = ini1; i <= fin1; i++){System.out.print(nums[i] + ", ");}
			System.out.println();
			System.out.print("Vector derecho: ");
			for (int i = fin1 + 1; i <= fin2; i++){System.out.print(nums[i] + ", ");}
			System.out.println();
			...
			for (int i = 0; i < posDest; i++){System.out.print(destino[i] + ", ");}
			System.out.println();
	...
	public static void main(String[] args) {
		...
		*/
		...
		for (int i=0; i<4; i++) System.out.print( nums[i] + ", " );
		System.out.println();
